...
const FirebaseAuthGithub: React.FC = () => {
  ...
  return (
    <div style={{ textAlign: 'center' }} className='flex justify-center items-center gap-5 p-0'>
      <button onClick={handleGithubSignIn} className="bg-black text-white px-4 py-2 rounded flex items-center gap-2 transition-all duration-200 ease-in-out hover:bg-white hover:scale-95 hover:text-black hover:rounded-xl hover:border-2 hover:border-black">
